...
const Header = () => {
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <h2 className='text-3xl sm:text-5xl font-semiboldmb-4'>Welcome to Authenticator</h2>
      <p className='mb-8 max-w-md'>Let's start witha aqiock product tour and we will have you up and running in no time!</p>
